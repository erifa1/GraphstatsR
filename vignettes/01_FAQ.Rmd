...
- **Bug related to double spaces in metadata:**
In HTML, consecutive spaces are automatically collapsed into a single one. This causes inconsistencies between the original dataset and the information displayed by the web application. **Conclusion:** Avoid using multiple spaces in metadata.
